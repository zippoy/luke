...
public class Luke extends Thinlet implements ClipboardOwner {
    ...
    public Object addComponent(Object parent, String compView, String handlerStr, Object[] argv) {
        ...
        try {
            if (handlerStr != null) {
                if (argv == null) {
                    handler = Class.forName(handlerStr).getConstructor(new Class[]{Thinlet.class}).newInstance(this);
                } else {
    ...
    public void openBrowse(Object path) {
        ...
        if (strPath != null) strPath = strPath.trim();
    ...
    public void openIndex(String name, boolean force, String dirImpl, boolean ro,
        ...
        try {
            ...
            try {
                SegmentInfos.readLatestCommit(d);
                existsSingle = true;
            } catch (Throwable e) {
                e.printStackTrace();
                lastException = e;
            ...
            if (!existsSingle) { // try multi
                ...
                if (files != null) {
                    for (File f : files) {
                        ...
                        existsSingle = false;
                        try {
                            SegmentInfos.readLatestCommit(d1);
                            existsSingle = true;
                        } catch (Throwable e) {
                            lastException = e;
                            e.printStackTrace();
    ...
    private void initFieldList(Object fList, Object fCombo, Object defFld) {
        ...
        TreeMap<String, FieldTermCount> termCountsSorted = new TreeMap<>(bvc);
    ...
    */
    ...
    public void toggleKeep(Object filesTable) {
        ...
        for (Object row : rows) {
            ...
            boolean deletable = Deletable == null || Deletable;
            deletable = !deletable;
    ...
    public void _actionCleanup(Object filesTable) {
        ...
        try {
            ...
            if (noDel.size() > 0) {
                ...
                for (Object aNoDel : noDel) msg.append("\n").append(aNoDel);
                errMsg = msg.toString();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean actionEditAdd(Object editdoc) {
        ...
        for (int i = 0; i < tabs.length; i++) {
            ...
            if (!ft.stored() && ft.indexOptions() == null) {
    ...
    public void actionMLT(Object docNum, Object docTable) {
        ...
        try {
            Collection<String> fieldNames = Util.fieldNames(ir, true);
    ...
    private void addFieldRow(Object table, String fName, IndexableField ixf, int docid) {
        Object row = create("row");
        add(table, row);
            ...
            try {
                if (info != null && info.hasNorms()) {
                    ...
                    if (norms.advanceExact(docid)) {
                        String val = Long.toString(norms.longValue());
        ...
        SlowThread st = new SlowThread(this) {
            public void execute() {
                try {
                    ...
                    Terms tfv = ir.getTermVector(DocId, fName);
                    if (tfv == null) {
    ...
    public Query createQuery(String queryString) throws Exception {
        ...
        Object ckSplitWs = find(srchOpts, "ckSplitWs");
        Object ckAutoPq = find(srchOpts, "ckAutoPq");
        ...
        qp.setSplitOnWhitespace(getBoolean(ckSplitWs, "selected"));
        qp.setAutoGeneratePhraseQueries(getBoolean(ckAutoPq, "selected"));
    ...
    public Similarity createSimilarity(Object srchOpts) {
        ...
        Object ckSimClassic = find(srchOpts, "ckSimClassic");
        ...
        } else if (getBoolean(ckSimClassic, "selected")) {
    ...
    private void _explainStructure(Object parent, Query q) throws IOException {
        ...
        if (clazz.equals("lucene.TermQuery")) {
            ...
            int max = BooleanQuery.getMaxClauseCount();
            Object n1 = create("node");
            ...
            mq.createWeight(is, false, 1.0F).extractTerms(terms);
            ...
            if (sqlass == SpanOrQuery.class) {
                ...
                sq.createWeight(is, false, 1.0F).extractTerms(terms);
                Object n1;
                n1 = create("node");
        ...
        */
            ...
            String defField = getDefaultField(find("srchOptTabs"));
            Set<Term> terms = new HashSet<Term>();
            q.createWeight(is, false, 1.0F).extractTerms(terms);
    ...
    private void addAutomaton(Object parent, Automaton a) {
        ...
        for (int state = 0; state < a.getNumStates(); state++) {
            ...
            msg.append(", ").append(numTransitions).append(" transitions");
    ...
    private void addNode(Object tree, Explanation expl) {
        ...
        add(tree, node);
        if (Objects.equals(getClass(tree), "tree")) {
    ...
    public void setupSelFont(Object selfont) {
        ...
        String currentFont = getFont().getFontName();
        ...
        setString(def, "text", currentFont + " (default)");
        ...
        for (int i = 0; i < fonts.length; i++) {
            ...
            add(cbFonts, choice);
            if (currentFont.equalsIgnoreCase(fonts[i].getFontName()))
    ...
    public void actionSetDecoder(Object fList, Object combo) {
        ...
        if (dec != null) {
            ...
            setString(cell, "text", "Decoder=null");
        }
        repaint(fList);
