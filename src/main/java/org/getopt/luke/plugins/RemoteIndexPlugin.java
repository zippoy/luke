...
/**
 * Source: https://github.com/md6nguyen/luke-remoteindex/blob/master/RemoteIndexPlugin.java
 */
public class RemoteIndexPlugin extends LukePlugin {
    ...
    private void openIndex(String uriTxt) {
        ...
        try {
            ...
            RemoteFileReader fileReader = RemoteFSTool.createRemoteFileReader(host, "1415");
