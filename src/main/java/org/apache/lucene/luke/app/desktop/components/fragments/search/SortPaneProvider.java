...
public class SortPaneProvider implements Provider<JScrollPane> {
  ...
  class SortTabImpl implements SortTabProxy.SortTab {
  ...
  class Listeners {
    ...
    ActionListener getFieldComboActionListener() {
    ...
    ActionListener getClearBtnListener() {
      return (ActionEvent e) -> {
  ...
  @Inject
  public SortPaneProvider(SortTabProxy sortTab) {
    this.listeners = new Listeners();

    sortTab.set(new SortTabImpl());
  }
  ...
  private JPanel sortConfigs() {
    ...
    fieldCombo1.addActionListener(listeners.getFieldComboActionListener());
    ...
    fieldCombo2.addActionListener(listeners.getFieldComboActionListener());
    ...
    clearBtn.addActionListener(listeners.getClearBtnListener());
    clear.add(clearBtn);
    panel.add(clear);
  ...
  public static class SortTabProxy extends ComponentProxy<SortTabProxy.SortTab> {

    public void setSearchModel(Search model) {
      get().setSearchModel(model);
    }

    public void setSortableFields(Collection<String> sortableFields) {
      get().setSortableFields(sortableFields);
    }

    interface SortTab extends ComponentProxy.Component {
